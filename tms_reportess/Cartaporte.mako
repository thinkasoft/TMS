...
<table style="font-size:60%" border="0" cellspacing="0">
	...
	<tr>
		<td style="border-left:2px solid #000000;border-right:2px solid #000000" colspan="2"><center>${folio or ''}</center></td>
	</tr>
	<tr>
    ...
    %if o.state  not in ('draft','cancel') and o.amount_total > 1 and o.partner_id.credit_limit > 0.0:
		...
		<tr>
			<td style="border-left:2px solid #000000;border-right:2px solid #000000" colspan="3"><b>RFC:</b> ${o.departure_address_id.vat_split or ''}</td>
			<td style="border-right:2px solid #000000" colspan="3"><b>RFC:</b> ${o.arrival_address_id.vat_split or ''}</td>
		</tr>
		<tr>
	...
	<table style="font-size:60%" border="0" cellspacing="0">
		<tr>
			...
			%if o.agreement_origin:
				%if o.agreement_id:
					%if o.agreement_id.payment_term:
		...
		<tr>
			...
			<td ><h1>ERROR!<br/>
			SOLO PUEDE IMPRIMIR LA CARTA PORTE SI ESTA CONFIRMADA O APROBADA, CON UN MONTO REAL Y SI EL CLIENTE TIENE CREDITO CONCEDIDO.</h1><br/>
			<h5>Consulte a su Administrador de Sistemas.</h5></td>
		</tr>
		</table>
